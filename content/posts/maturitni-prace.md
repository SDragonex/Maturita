+++
title = "Maturitní práce s obhajobou"
...
> **Zkouška profilové části maturitní zkoušky**
...
## Oblasti pro maturitní práce

| č. | Oblast |
|----|--------|
| 1  | Software a webové aplikace |
| 2  | Počítačová grafika |
| 3  | Programování |
| 4  | Počítačové sítě |
| 5  | Kybernetická bezpečnost |
| 6  | Databáze a databázové systémy |
| 7  | Operační systémy |

---

> [!NOTE]
> Maturitní práce je rozsáhlý projekt z jedné z výše uvedených oblastí.
> Student ji vypracovává samostatně a obhajuje před zkušební komisí.
